...
class VideoGridAdapter(videoAmount: Int, context: Context): VideoBaseAdapter(videoAmount, context) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val rootView = LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_videos_grid,parent,false)
